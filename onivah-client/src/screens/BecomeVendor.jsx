...
const BecomeVendor = () => {
    ...
    const drawer = (
        <Box onClick={handleDrawerToggle} sx={{ textAlign: 'center' }}>
            ...
            <Divider />
            <List sx={{ display: "flex", flexDirection: "column", justifyContent: "start", alignItems: "start" }}>
                {navItems.map((item) => (
                    <ListItem button key={item.label}>
                        <ListItemText onClick={() => handleNavigation(item.path)} primary={item.label} sx={{ textAlign: 'start' }} />
                    </ListItem>
                ))}
            </List>
        </Box>
        ...
        <>
            ...
            <Box
                sx={{
                    ...
                    position: "relative",
                    backgroundImage:
                        "url('https://img.freepik.com/free-photo/umbrella-with-chair-hotel-pool-resort_74190-311.jpg?uid=R133306793&ga=GA1.1.1773690977.1730112906&semt=ais_hybrid&w=740')",
                    ...
                    <Grid container spacing={6} alignItems="center">
                        ...
                        <Grid item xs={12} md={6}>
                            ...
                            >
                                <Box
                                    component="img"
                                    src="https://img.freepik.com/premium-photo/elegantly-dressed-couple-luxurious-setting_1326977-1141.jpg?uid=R133306793&ga=GA1.1.1773690977.1730112906&semt=ais_hybrid&w=740"
                                    alt="How It Works"
                                    sx={{
                                        width: '100%',
                                        maxHeight: 500,
